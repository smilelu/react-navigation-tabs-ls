...
export default function createTabNavigator(TabView) {
  class NavigationView extends React.Component {
    ...
    render() {
      ...
      return <TabView {...options} getLabelText={this._getLabelText} renderIcon={this._renderIcon} renderScene={this._renderScene} onIndexChange={this._handleIndexChange} onTabPress={this._handleTabPress} navigation={navigation} descriptors={descriptors} screenProps={screenProps} />;
    }
  }
